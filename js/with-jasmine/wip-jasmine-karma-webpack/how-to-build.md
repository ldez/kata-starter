...
git repository:
keywords: project, jasmine, karma, babel, webpack
author: you
license: (ISC)
...
```shell
npm install -D karma webpack karma-webpack babel-loader
# npm install -D karma webpack karma-webpack babel-loader jasmine-core karma-jasmine karma-phantomjs-launcher phantomjs
```
...
Attention le preprocessor doit se situer avant celui de Babel sinon la couverture de code se fait sur le code généré par Babel.
