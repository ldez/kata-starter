...
git repository:
keywords: project, mocha, karma, TypeScript
author: you
license: (ISC)
...
```shell
npm install -D karma typescript karma-typescript-preprocessor chai karma-chai sinon karma-sinon
# npm install -D karma typescript karma-typescript-preprocessor chai karma-chai sinon karma-sinon mocha karma-mocha karma-phantomjs-launcher phantomjs
```
