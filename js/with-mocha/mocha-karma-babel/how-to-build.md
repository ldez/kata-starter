...
git repository:
keywords: project, mocha, karma, babel
author: you
license: (ISC)
...
## Install Karma, Chai, Sinon & Babel

```shell
npm install -D karma karma-babel-preprocessor chai karma-chai sinon karma-sinon
# npm install -D karma karma-babel-preprocessor chai karma-chai sinon karma-sinon mocha karma-mocha karma-phantomjs-launcher phantomjs
```
...
```shell
# Coverage
npm install -D karma-coverage isparta
```
...
Il faut modifier la configuration de Babel :
